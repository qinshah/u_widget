        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                UButton(variant: UButtonVariant.filled, child: const Text('Filled')),
                UButton(variant: UButtonVariant.outlined, child: const Text('Outlined')),
                UButton(variant: UButtonVariant.text, child: const Text('Text')),
                UButton(variant: UButtonVariant.ghost, child: const Text('Ghost')),
              ],
            ),
